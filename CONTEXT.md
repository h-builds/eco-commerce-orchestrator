...
- `0db221c` - chore(config): ignore generated Wasm bindings and build output
...
- **Generated Files:** Auto-generated files and build output (e.g., Wasm shim bindings) should be excluded from static analysis by adding them to `.semgrepignore` and `.eslintignore`.
