...
export function DownloadExecutiveReportButton() {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={[
        'tour-executive-report inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-900/50 px-4 py-3 text-sm font-bold tracking-wide text-slate-200 backdrop-blur-md transition-colors',
        disabled
